...
public class User_read {
	...
	public void test_UserReadPatient1() {
		...
		assertEquals( "Name: Alice"+System.lineSeparator()+"ID: 9102034567"+System.lineSeparator()+"Info: Sjukdom1",a.read("Alice"));
	...
	public void test_UserReadNurse2() {
		...
		b.add(new Division("D1"));
		Nurse a = new Nurse("Nurse1", b);
		assertEquals("Name: Bob"+System.lineSeparator()+"ID: 9203045678"+System.lineSeparator()+"Info: Sjukdom2",a.read("Bob"));
